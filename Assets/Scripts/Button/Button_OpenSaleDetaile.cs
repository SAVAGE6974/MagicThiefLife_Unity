...
public class Button_OpenSaleDetaile : MonoBehaviour
{
    ...
    [FoldoutGroup("Main Item")] public Text MainItemName;
    [FoldoutGroup("Main Item")] public Image MainItemIcon;
    [FoldoutGroup("Main Item")] public Text MainItemDescription;
    [FoldoutGroup("Main Item")] public Text MainItemPrice;
    [FoldoutGroup("Main Item")] public Text PlayerMoney; // 이 Text는 PlayerPrefs에서 읽어온 플레이어의 돈을 표시합니다.
    ...
    [FoldoutGroup("First Item")] public Text firstItemName;
    [FoldoutGroup("First Item")] public Image firstItemIcon;
    [FoldoutGroup("First Item")] public Text firstItemPrice;
    [FoldoutGroup("First Item")] public Text fistItemDescription;

    [InfoBox("해당 아이템들의 실제 가격과 Button의 가격등을 일치해야하므로 Content아래의 ItemSlot의 Text와 이름이 이 스크립트와 함께 작성해야합니다. \n 또한 Content아래의 ItemSlot에 할당되여있는 함수를 직접 변경해야하며, 변경이 되지 않을시 가격이 일정하게 지불이 안되는 버그가 발생합니다.")]
    [FoldoutGroup("Second Item")] public Text secondItemName;
    [FoldoutGroup("Second Item")] public Image secondItemIcon;
    [FoldoutGroup("Second Item")] public Text secondItemPrice;
    [FoldoutGroup("Second Item")] public Text secondItemDescription;
